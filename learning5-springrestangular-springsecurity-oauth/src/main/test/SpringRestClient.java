...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8080/learning5-springrestangular-springsecurity-oauth";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/learning5-springrestangular-springsecurity-oauth/oauth/token";
    ...
    private static void listAllUsers(AuthTokenInfo tokenInfo){
        ...
        ResponseEntity<List> response = restTemplate.exchange(REST_SERVICE_URI+"/users/rest/getallusers"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
